...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--width", type=int, default=320, help="Downscaled width used for feature computation.")
    parser.add_argument("--workers", type=int, default=6, help="Number of worker processes for pairwise similarities.")
    parser.add_argument("--w_ssim", type=float, default=0.7, help="Weight for the SSIM similarity component.")
    parser.add_argument("--w_hist", type=float, default=0.2, help="Weight for the HSV histogram similarity component.")
    parser.add_argument("--w_orb", type=float, default=0.1, help="Weight for the ORB similarity component.")
